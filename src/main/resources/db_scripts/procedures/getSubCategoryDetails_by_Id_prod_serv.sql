CREATE PROCEDURE `getSubCategoryDetails_by_Id_prod_serv`(IN location_id INT ,
 IN department_id INT , IN category_id INT , IN sub_category_id INT)
BEGIN
...
from  locations_prod_serv l
  ...
  and s.sub_category_id = sub_category_id
   ;
